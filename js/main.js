...
// Home Slider Trainers ==================================================================

const homeTrainersSwiper = new Swiper('.main-home__trainers-container', {
	slidesPerView: 2,
	navigation: {
	...
	pagination: {
		el: '.trainers__swiper-pagination',
		clickable: true,
	},
	watchOverflow: true,
	spaceBetween: 30,
...
const galleryItems = new Swiper('.gallery__items', {
	slidesPerView: 3,
	slidesPerGroup: 3,
	slidesPerColumn: 2,
	watchOverflow: true,
...
// Blog Slider Trainers ==================================================================

const blogsTrainersSwiper = new Swiper('.blogs-sidebar__trainers-container', {
	slidesPerView: 2,
	navigation: {
		prevEl: '.trainers__swiper-btn-prev',
		nextEl: '.trainers__swiper-btn-next',
...
const blogsGallerySwiper = new Swiper('.blog__slider-container', {
	slidesPerView: 1,
	autoHeight: true,
	navigation: {
		prevEl: '.blog__slider-btn-prev',
		nextEl: '.blog__slider-btn-next',
	},
	pagination: {
...
const menuSidebarIcon = document.querySelector('.sidebar-menu-icon');
const menuSidebarIconInner = document.querySelector('.sidebar-menu-icon--inner');
const sidebar = document.querySelector('.blogs-body__sidebar');

if (menuSidebarIcon) {
	menuSidebarIcon.addEventListener("click", function () {
		sidebar.classList.add('blogs-body__sidebar--active');
	});
	menuSidebarIconInner.addEventListener("click", function () {
		sidebar.classList.remove('blogs-body__sidebar--active');
	});
}
...
// Btn Blog Read More
const btnBlogReadMore = document.querySelectorAll('.blog__box-btn');

if (btnBlogReadMore) {

	btnBlogReadMore.forEach(
		(item) => item.addEventListener('click', function(e) {
			e.preventDefault();
			const id = e.target.getAttribute('href').replace('#', '');

			document.getElementById(id).classList.toggle('blogs-body__blog-text--hidden');
		})
	);
}
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		async function formSend(e) {
			...
			if (error === 0) {
				...
				formMessage.innerHTML = 'Check the data (Name, Email, Subject or Message)';
			}
		}
